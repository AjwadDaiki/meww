...
const CategorySchema = new mongoose.Schema(
  {
    ...
    negativePrompt: { type: String, default: 'no humans, no text overlays, no watermark, no logos, no distorted anatomy, no extra limbs, no cartoon style, no anime style' },
    generationModel: { type: String, default: 'seedance-2-lite' },
...
const CATEGORIES = [
  ...
  // MUSIC (8)
  { slug: 'jazz-trumpet', section: 'music', order: 1,
  ...
  { slug: 'rock-guitarist', section: 'music', order: 2,
  ...
  { slug: 'rap-booth', section: 'music', order: 5,
  ...
  // SPORTS (8)
  { slug: 'football-goal-celebration', section: 'sports', order: 1,
  ...
  { slug: 'basketball-dunk', section: 'sports', order: 2,
  ...
  { slug: 'boxing-ring-knockout', section: 'sports', order: 3,
  ...
  // DANCE (6)
  { slug: 'griddy-gym', section: 'dance', order: 1,
